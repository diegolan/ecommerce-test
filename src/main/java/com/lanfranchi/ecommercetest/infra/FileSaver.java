...
public class FileSaver {
	...
	public String write(String baseFolder, Part multipartFile) {
		...
		try {
			s3.putObject("ecommerce", fileName, multipartFile.getInputStream(), new ObjectMetadata());
//			return "https://s3.amazonaws.com/ecommerce/" + fileName;
			return "http://localhost:9444/s3/ecommerce/" + fileName;
